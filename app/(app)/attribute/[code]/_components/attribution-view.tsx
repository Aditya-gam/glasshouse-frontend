          ...
          <section className="evidence" aria-label="Evidence">
            <div className="ev-intro">
              ...
              <p className="ev-collective">
                ...
                Lisbon — together they pin it. A photo&rsquo;s GPS narrows it to your neighborhood.
                Even without that photo, the text alone still points here (≈
            ...
            <div className="summary-card">
              ...
              <div className="sum-rel">
                ...
                <div className="sum-range">
                  calibrated range {finding.lo}–{finding.hi}% · not the model&rsquo;s raw confidence
                </div>
              </div>
              ...
              <p className="sum-nofalse">
                ...
                Breaking the inference reduces what an adversary can recover — it can&rsquo;t erase
                the past.
              </p>
            </div>
          </aside>
